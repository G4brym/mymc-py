...
# Pure-Python implementations are always used in this port (the optional
# C acceleration module "mymcsup" from the original project is not bundled).
